...
const face=(i,cls='')=>{const a=byId(i);return `<span class="ll43Face ${cls}" data-avatar-face="${a.id}" style="display:block;overflow:hidden;background:#0b1120"><img src="${a.src}" alt="LifeLingo avatar" loading="eager" decoding="async" style="display:block;width:100%;height:100%;object-fit:cover;object-position:center;image-rendering:auto"></span>`};
function syncProfileButton(){const b=$('#profileBtn');if(!b||!user())return;const s=load();b.style.width='52px';b.style.height='52px';b.style.padding='3px';b.style.borderRadius='50%';b.style.overflow='hidden';b.style.verticalAlign='middle';b.style.display='inline-grid';b.style.placeItems='center';if(s.surpriseUsed){const a=byId(s.avatar);b.innerHTML=`<img src="${a.src}" alt="Profile avatar" style="width:100%;height:100%;object-fit:cover;border-radius:50%;display:block">`;b.setAttribute('aria-label','Open profile')}else{b.innerHTML='<span style="font-size:23px;font-weight:900;color:#c9a7ff">?</span>';b.setAttribute('aria-label','Open profile')}}
